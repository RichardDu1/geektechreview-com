...
const industries = ["Smart Home Gadgets", "Computer Peripherals", "Drones & Tech Toys", "Wearable Technology", "Home Theater Equipment"];
...
async function generateSeedTopicsBatch(batchSize = 20) {
  ...
  const prompt = `
You are a Consumer Electronics Reviewer for GeekTechReview. Focus on detailed tech specs, real-world usability, build quality, and comparisons with similar gadgets.
